...
class HomeSeriesProductReview1Screen extends StatefulWidget {
  const HomeSeriesProductReview1Screen({super.key});

  @override
  State<HomeSeriesProductReview1Screen> createState() =>
      _HomeSeriesProductReview1ScreenState();
}

class _HomeSeriesProductReview1ScreenState
    extends State<HomeSeriesProductReview1Screen> {
