...
class HomeSeriesProductOverViewScreen extends StatefulWidget {
  const HomeSeriesProductOverViewScreen({super.key});

  @override
  State<HomeSeriesProductOverViewScreen> createState() =>
      _HomeSeriesProductOverViewScreenState();
}

class _HomeSeriesProductOverViewScreenState
    extends State<HomeSeriesProductOverViewScreen> {
