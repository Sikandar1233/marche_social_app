...
class HomeSeriesProductSpecsScreen extends StatefulWidget {
  const HomeSeriesProductSpecsScreen({super.key});

  @override
  State<HomeSeriesProductSpecsScreen> createState() =>
      _HomeSeriesProductSpecsScreenState();
}

class _HomeSeriesProductSpecsScreenState
    extends State<HomeSeriesProductSpecsScreen> {
